...
var methodParamMap = map[string][]string{
	...
	"Disconnect":           []string{},
	"ProfileInfo":          []string{},
	"ProfileAdd":           []string{"profileName", "apnStatus", "apnName", "dialupNumber", "username", "password", "authMode", "ipType", "asDefault"},
	"ProfileDel":           []string{"profileIndex", "defaultIndex"},
	"SmsFeatures":          []string{},
	...
	"DmzConfig":            []string{},
	"DmzConfigSet":         []string{"enabled", "dmzIPAddress"},
	"SipAlg":               []string{},
...
var methodCommentMap = map[string]string{
	...
	"ProfileAdd":           "ProfileAdd add new profile (ie, APN).",
